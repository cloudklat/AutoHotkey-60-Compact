/* Config fix External Keyboard utk Laptop
DA Meca 6, Sesuaikan sendiri jika beda Key & Merk, 
Karena ada beberapa Media Button yang sudah Terpasang Bawaan Pabrik
Work di semua tipe Laptop Asus X441 dengan Layout yang sama
*/
...
; Atur Kecerahan Layar (Wajib Urutan Pertama) (Gak Work Baris Terakhir)

BS := new BrightnessSetter()

!6::BS.SetBrightness(10)
!5::BS.SetBrightness(-10)
...
!o::
Suspend
ToolTip,% a_isSuspended?"Off":"On", 1000, 100
setTimer, tooltipoff, 1000 ; run tooltipoff after 1 second
return
...
; Wi-Fi On/Off (Wajib Beri Run as Admin)

1::Run, *RunAs %ComSpec% /c netsh interface set interface name="Wi-Fi" admin=disabled,, Hide
return

2::Run, *RunAs %ComSpec% /c netsh interface set interface name="Wi-Fi" admin=enabled,, Hide
return
...
; Tutup hanya 1 Tab Browser & Jendela Aplikasi Aktif
